...
/*
 * Copy of bootstrap_package SvgUtility
 * https://github.com/benjaminkott/bootstrap_package/blob/master/Classes/Utility/SvgUtility.php
 *
...
class SvgUtility
{
    ...
    public static function getInlineSvg(
        ...
        try {
            ...
            // Override attributes
            $class = filter_var(trim((string)$class), FILTER_SANITIZE_FULL_SPECIAL_CHARS);
